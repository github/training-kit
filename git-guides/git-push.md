...
After you make and commit changes locally, you can share them with the remote repository using `git push`. It's important to make commits on branches that are for specific purposes, so that you can push the changes frequently.
