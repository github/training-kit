...
(function ( $ ) {
    ...
    $.fn.github_graph = function( options ) {
        ...
        */
        var processListTimeStamp = function(list_timestamp, callback){
          $.getJSON( list_timestamp, function( jsonData ) {
            $.each(jsonData, function(i, obj) {
              ...
              obj_jsonData[display_date].push(objForArray);
              console.log("Adding " + JSON.stringify(objForArray) + " to array; let's verify: obj[" + display_date + "]=" + JSON.stringify(obj_jsonData[display_date]));
        ...
        var start = function(){
          processListTimeStamp( settings.data, function (display_date){
  ...
  */
        ...
        var mouseClick = function(evt){
          ...
          $('.contribution_graph').height( expanded_tip.height() + 110 );
