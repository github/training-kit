...
.menu-item:first-child {
  border-top:0;border-top-left-radius:2px;
...
.menu-item:hover{
  text-decoration:none;background-color:#f6f8fa;
}

.menu-item.selected{
  font-weight:600;color:#24292e;cursor:default;background-color:#fff;
}
